...
class RouteConstants {
  ...
  static final String GENERIC_ROUTE_LAYER_ID = "mapbox-navigation-route-layer";
  ...
  static final String GENERIC_ROUTE_SHIELD_LAYER_ID = "mapbox-navigation-route-shield-layer";
